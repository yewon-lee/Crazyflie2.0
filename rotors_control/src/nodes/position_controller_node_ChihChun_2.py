...
class PositionControllerNode_ChihChun(object):
    ...
    def __init__(self):
        ...
        self.pub_rotor_vel = rospy.Publisher('/crazyflie2_2/command/motor_speed', Actuators, queue_size=1)
        ...
        self.sub_currpos = rospy.Subscriber('/crazyflie2_2/odometry', Odometry, self._currpos_callback)
