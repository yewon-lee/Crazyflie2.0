...
class roll_pitch_yawrate_thrust_crazyflie(object):
    ...
    def __init__(self, pitch_c, roll_c, yaw_rate_c, p, q, r, roll, pitch, yaw, thrust):

        self.M_PI = 3.14159265358979323846 # pi
        self.ANGULAR_MOTOR_COEFFICIENT = 1.8#0.2685 # ANGULAR_MOTOR_COEFFICIENT
        self.MOTORS_INTERCEPT = 2270 #426.24 # MOTORS_INTERCEPT [rad/s]
        ...
        self.rate_gain_ki = [0, 0, 1000] #95.6839
        self.thrust_percentage = 1

        # commands
        self.pitch_c = pitch_c
        self.roll_c = roll_c
        self.yaw_rate_c = yaw_rate_c
